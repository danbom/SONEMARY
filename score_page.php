...
<section class="section2-contents">
		...
		<div class="section2-info">
			<div class="info-main"><?=$data[user_id]?><?=$data[regdate,0,10]?></div>
...
?>
        ...
        <section class="section2-contents">
            ...
            <div class="section2-info">
              <div class="info-main">User1</div>
              <div class="info-sub">This is amazing ~~~ !</div>
              <div>
                <ul class="info-scores">
                  <li>Story <p>9</p> </li>
                  <li>Acting <p>7</p> </li>
            ...
            <div class="section2-info">
              <div class="info-main">User2</div>
              <div class="info-sub">I love this movie ~~~ !</div>
              <div>
                <ul class="info-scores">
                  <li>Story <p>9</p> </li>
                  <li>Acting <p>7</p> </li>
